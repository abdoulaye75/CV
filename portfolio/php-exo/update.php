...
if (isset($_GET['id'])) { // si l'utilisateur clique sur "Modifier la randonnée"
	...
	echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button>La randonnée a été modifiée avec succès.</div>';
}
}
...
<body>
	...
	<h1 style="margin-left: 15px;">Modifier</h1>
